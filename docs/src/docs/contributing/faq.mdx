...
Add a new field to a [config struct](https://github.com/nalekseevs/itns-golangci-lint/blob/master/pkg/config/config.go).
Document it in [.golangci.reference.yml](https://github.com/nalekseevs/itns-golangci-lint/blob/master/.golangci.reference.yml).
Pass it to a linter.
