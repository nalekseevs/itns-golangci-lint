...
You can see more examples of using `//nolint` in [our tests](https://github.com/nalekseevs/itns-golangci-lint/tree/master/pkg/result/processors/testdata) for it.
