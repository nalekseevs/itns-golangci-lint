...
import (
	...
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/asasalint"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/asciicheck"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/bidichk"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/bodyclose"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/canonicalheader"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/containedctx"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/contextcheck"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/copyloopvar"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/cyclop"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/decorder"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/depguard"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/dogsled"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/dupl"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/dupword"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/durationcheck"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/err113"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/errcheck"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/errchkjson"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/errname"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/errorlint"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/execinquery"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/exhaustive"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/exhaustruct"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/exportloopref"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/fatcontext"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/forbidigo"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/forcetypeassert"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/funlen"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gci"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/ginkgolinter"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gocheckcompilerdirectives"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gochecknoglobals"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gochecknoinits"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gochecksumtype"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gocognit"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/goconst"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gocritic"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gocyclo"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/godot"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/godox"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gofmt"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gofumpt"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/goheader"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/goimports"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gomoddirectives"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gomodguard"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/goprintffuncname"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gosec"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gosimple"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/gosmopolitan"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/govet"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/grouper"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/importas"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/inamedparam"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/ineffassign"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/interfacebloat"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/intrange"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/ireturn"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/lll"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/loggercheck"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/maintidx"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/makezero"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/mirror"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/misspell"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/mnd"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/musttag"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/nakedret"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/nestif"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/nilerr"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/nilnil"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/nlreturn"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/noctx"
	...
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/predeclared"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/promlinter"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/protogetter"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/reassign"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/revive"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/rowserrcheck"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/sloglint"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/spancheck"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/sqlclosecheck"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/staticcheck"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/stylecheck"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/tagalign"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/tagliatelle"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/tenv"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/testableexamples"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/testifylint"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/testpackage"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/thelper"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/tparallel"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/unconvert"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/unparam"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/unused"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/usestdlibvars"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/varnamelen"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/wastedassign"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/whitespace"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/wrapcheck"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/wsl"
	"github.com/nalekseevs/itns-golangci-lint/pkg/golinters/zerologlint"
...
func (LinterBuilder) Build(cfg *config.Config) ([]*linter.Config, error) {
	...
	return []*linter.Config{
		...
		linter.NewConfig(nolintlint.New(&cfg.LintersSettings.NoLintLint)).
			...
			WithPresets(linter.PresetStyle).
			WithAutoFix().
			WithURL("https://github.com/nalekseevs/itns-golangci-lint/blob/master/pkg/golinters/nolintlint/README.md"),
	}, nil
}
